...
public static class HealthChecksConfiguration
{
    ...
    {
        builder
            .AddMySql(configuration.GetConnectionString("DefaultConnection")!, "SELECT 1", name: "Database")
            .AddDbContextCheck<ApplicationDbContext>("DatabaseContext");

        var regisConnection = configuration.GetConnectionString("RedisConnection");
